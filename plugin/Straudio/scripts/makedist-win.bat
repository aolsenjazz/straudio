...
if %DEMO_ARG% == "demo" (
  echo Making Straudio Windows DEMO VERSION distribution ...
  set DEMO=1
) else (
  echo Making Straudio Windows FULL VERSION distribution ...
  set DEMO=0
)
...
echo Making Installer ...
  ...
  REM :32-Bit-is
  REM REM "%ProgramFiles%\Inno Setup 6\iscc" /Q ".\installer\Straudio.iss"
  REM goto END-is
