...
xcodebuild -project ./projects/$PLUGIN_NAME-macOS.xcodeproj -xcconfig ./config/$PLUGIN_NAME-mac.xcconfig DEMO_VERSION=$DEMO -target "All" -jobs=1 -UseModernBuildSystem=YES -configuration Release | xcpretty #&& exit ${PIPESTATUS[0]}
