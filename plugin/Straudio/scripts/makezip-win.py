...
def main():
  ...
  if not zip:
    installer = "\\build-win\\installer\\Straudio Installer.exe"
    
    if demo:
      installer = "\\build-win\\installer\\Straudio Demo Installer.exe"
    ...
    files = [
      projectpath + "\\build-win\\Straudio.vst3\\Contents\\x86_64-win\\Straudio.vst3",
      projectpath + "\\build-win\\Straudio_x64.exe"  
    ]
  ...
  files = [
    projectpath + "\\build-win\\pdbs\\Straudio-vst3_x64.pdb",
    projectpath + "\\build-win\\pdbs\\Straudio-app_x64.pdb"  
  ]
